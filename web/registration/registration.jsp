...
<head>
    ...
    <script src="RegistrationControl.js"></script>
</head>
<body>
<div class="container-fluid" style="margin-top: 1%">
    <%if (request.getAttribute("username_not_valid") != null) {%>
    <div class="alert alert-danger" role="alert">
        Lo username <label style="font-style: italic"><%=request.getAttribute("username_not_valid")%>
    </label> non è valido.
    </div>
    <%}%>
    <% HashMap<String, Object> attributes = (HashMap<String, Object>) request.getAttribute("attributes");%>
    <% if (attributes != null) {%>
    <jsp:include page="registration_box.jsp">
        ...
        <jsp:param name="newScout" value="<%=attributes.get(\"scout\")%>"/>
    </jsp:include>
    <% } else {%>
    <jsp:include page="registration_box.jsp"/>
    <%}%>
