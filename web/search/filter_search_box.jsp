...
<div class="panel panel-default" style="position: fixed">
    ...
    <div class="panel-body" style="margin-bottom:-5%;">
        <form name="search-form" class="form-horizontal col-sm-12" method="get" action="structure_search.jsp" onsubmit="return NomeCheck()"> <!-- style="background-color: rgba(36,154,96,0.55); border-radius: 2%;"> -->
