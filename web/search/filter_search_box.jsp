...
<div class="panel panel-default" style="position: fixed">
    ...
    <div class="panel-body" style="margin-bottom:-5%;">
        <form name="search-form" class="form-horizontal col-sm-12" method="get" action="structure_search.jsp">
            <!-- style="background-color: rgba(36,154,96,0.55); border-radius: 2%;"> -->
            <div class="form-group">
                <div class="row">
                    <div class="col-sm-6">
                        <label class="control-label">Data di inizio:</label>
                        <input name="start-date" value="${param.startdate}" type="text" class="form-control input-sm"
                               placeholder="GG-MM-AAAA">
                    </div>
                    <div class="col-sm-6">
                        <label class="control-label">Data di fine:</label>
                        <input name="end-date" value="${param.enddate}" type="text" class="form-control input-sm"
                               placeholder="GG-MM-AAAA">
                    </div>
                </div>
                <div class="row">
                    <div class="col-sm-6">
                        ...
                        <input name="region" value="${param.region}" type="text" class="form-control input-sm"
                               placeholder="Inserisci la regione">
                    </div>
                    <div class="col-sm-6">
                        <label class="control-label">Citt&agrave:</label>
                        <input name="city" value="${param.city}" type="text" class="form-control input-sm"
                ...
                <div class="row">
                    <div class="col-sm-12">
                        ...
                        <input name="structure" value="${param.structure}" type="text" class="form-control input-sm"
                               placeholder="Inserisci la struttura">
                    </div>
                </div>
                <div class="row">
                    <div class="col-sm-3">
