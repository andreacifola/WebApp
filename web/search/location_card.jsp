...
<%int myFeedBack = -1;%>
    ...
    <div style="margin: 1%">
        ...
        <%if (structuresBean.getStructures().get(structureIndex)
        ...
        <div style="max-height: 200px; overflow-y: scroll;">
                ...
                <div class="well well-sm">
                    <label><small><%=structuresBean.getStructures().get(structureIndex)
