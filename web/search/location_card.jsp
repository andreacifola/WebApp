...
<div style="margin: 1%">
    <div class="row">
        <div class="col-sm-9" style="margin-top: 0.7%">
            <label><h4 class="list-group-item-heading">Locazione ID: <%=structuresBean.getStructures().get(structuresBean.getStructureSelected()).getLocations().get(locationIndex).getId()%></h4></label>
        </div>
    ...
    <div class="row" style="padding-top: 2%">
        ...
        <div>
            ...
            <% if (logged_user != null && logged_user.getUsername() != null && paymentBean.getStart_date() != null && paymentBean.getEnd_date() != null){ %>
    ...
    <div style="max-height: 200px; overflow-y: scroll;">
        <%for (int i = 0; i < structuresBean.getStructures().get(structuresBean.getStructureSelected())
            ...
            if (logged_user != null && logged_user.getUsername() != null && structuresBean.getStructures().get(structuresBean.getStructureSelected())
                    .getLocations().get(locationIndex).getFeedbacks().get(i).getUsername().equals(logged_user.getUsername())){
                myFeedBack = i;
                continue;
            }
        %>
