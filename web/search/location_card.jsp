...
<%Integer structureIndex = Integer.valueOf(request.getParameter("structure_index")),
        locationIndex = Integer.valueOf(request.getParameter("location_index"));%>
...
<div style="margin: 1%">
    <div class="row">
        ...
        <div class="col-sm-2">
            <button type="button" class="btn btn-default btn-block">Aggiungi feedback</button>
        </div>
        <div class="col-sm-2">
    ...
    <div class="row" style="padding-top: 2%">
        <div class="col-sm-8" style="display: inline-block; float: none; vertical-align: middle">
            <div>
                <div class="row">
                    <div class="col-sm-3">
        ...
        <div>
            ...
            <form method="get" action="../payment/checkout.jsp">
                <button type="submit" name="select" value="${param.id}" class="btn btn-primary btn-block">Seleziona</button>
            </form>
        </div>
    </div>
    </div>
